            ...
            for (int i = 0; i < namesLength; i++) {
                ...
                for (int j = 0; j < numberOfAnnotations; j++) {
                    if (names[i][j + 1].contains("Test1()")) {          //поиск аннотации Test1
                        ...
                        CalculationResultTest object1 = new CalculationResultTest();
                        ...
                        try {
                            var result1 = methodsAll[i].invoke(object1);    //выполнение аннотации Test1 для i-ого метода
