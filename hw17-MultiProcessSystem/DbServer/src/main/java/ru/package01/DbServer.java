...
public class DbServer extends UnicastRemoteObject implements EchoInterface {
    ...
    public static void main(String[] args) {
        try {
            ...
            Naming.rebind("//localhost/DbServer", new DbServer(SERVER_PORT));
            System.out.println("waiting for MessageServer connection...");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    public String echo(String data) {
        ...
        Gson gson = new Gson();
        System.out.println(String.format("data from MessageServer (client) (2): %s", data));
